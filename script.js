const translations = {
  fr: {
    ...
    aboutText: "Je suis développeur web passionné et curieux de nouvelles technologies. J’aime créer des sites web modernes, rapides et intuitifs, adaptés à tous les appareils. Que ce soit pour des projets personnels ou professionnels, mon objectif est de transformer vos idées en expériences digitales efficaces et esthétiques. J’accorde une grande importance au design, à la performance et à l’accessibilité, afin que chaque utilisateur vive une expérience agréable et mémorable.",
  ...
  it: {
    ...
    aboutTitle: "Chi sono",
    aboutText: "Sono uno sviluppatore web appassionato e curioso delle nuove tecnologie. Amo creare siti web moderni, veloci e intuitivi, ottimizzati per tutti i dispositivi. Che si tratti di progetti personali o professionali, il mio obiettivo è trasformare le tue idee in esperienze digitali efficaci ed eleganti. Do grande importanza al design, alle prestazioni e all’accessibilità, affinché ogni utente viva un’esperienza piacevole e memorabile.",
    skillsTitle: "Competenze",
    skill1: "HTML5 / CSS3",
    skill2: "JavaScript",
    skill3: "React",
    skill4: "Bootstrap",
    skill5: "Database (MySQL)",
