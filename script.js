const translations = {
  ...
  it: {
    ...
    project1Text: "Un sito vetrina responsive per un'azienda locale.",
    project2Title: "Progetto 2",
    project2Text: "Applicazione web con React e API esterna.",
    project3Title: "Progetto 3",
    project3Text: "Dashboard interattivo in JavaScript.",
